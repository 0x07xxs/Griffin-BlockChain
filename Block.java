...
public class Block {
    ...
    public synchronized String computeMerkleRoot(ArrayList<String> lstItems) {
        ...
        node1.sHash = BlockchainUtil.generateHash(lstItems.get(0));
        node2.sHash = BlockchainUtil.generateHash(lstItems.get(1));
        node3.sHash = BlockchainUtil.generateHash(lstItems.get(2));
        node4.sHash = BlockchainUtil.generateHash(lstItems.get(3));
